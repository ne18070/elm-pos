...
// -- Permissions Definition (Source Unique de Vérité) --------------------------
...
export type PermissionKey = keyof typeof PERMISSIONS_MAP;

export const PERMISSIONS: Record<PermissionKey, PermissionMeta> = PERMISSIONS_MAP as any;
...
export function hasFeature(business: Business | null | undefined, feature: string): boolean {
  ...
  const bTypes = business.types ?? [];
  const bFeatures = business.features ?? [];
  
  if (bFeatures.includes(feature)) return true;
...
export function checkPermission(
  ...
  // 1. Strict Feature Check (D'ABORD)
  if (meta.feature) {
    if (!business) return false;
  ...
  // 2. Owners bypass (seulement si feature validée au-dessus)
...
/** Named shortcuts */
export const canViewFinancials = (r: UserRole|null|undefined, o?: any, b?: Business|null) => checkPermission(r, 'view_financials', o, b);
export const canManageSettings = (r: UserRole|null|undefined, o?: any, b?: Business|null) => checkPermission(r, 'manage_settings', o, b);
export const canCancelOrders   = (r: UserRole|null|undefined, o?: any, b?: Business|null) => checkPermission(r, 'cancel_orders', o, b);
export const canManageRooms    = (r: UserRole|null|undefined, o?: any, b?: Business|null) => checkPermission(r, 'manage_rooms', o, b);
export const canManageExpenses = (r: UserRole|null|undefined, o?: any, b?: Business|null) => checkPermission(r, 'manage_expenses', o, b);
export const canManageTeam     = (r: UserRole|null|undefined, o?: any, b?: Business|null) => checkPermission(r, 'manage_team', o, b);
export const canDelete         = (r: UserRole|null|undefined, o?: any, b?: Business|null) => checkPermission(r, 'delete_data', o, b);
