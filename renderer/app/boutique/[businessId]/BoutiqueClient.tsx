    ...
    <div className="min-h-screen bg-slate-50 pb-32">
      ...
      {cartCount > 0 && !showCart && (
        <div className="fixed bottom-6 inset-x-0 z-30 flex justify-center px-4">
          <button
            onClick={() => setShowCart(true)}
            className="flex items-center gap-3 bg-brand-600 hover:bg-brand-700 text-content-primary px-6 py-4 rounded-2xl shadow-xl shadow-brand-600/30 font-semibold transition-all max-w-sm w-full"
          >
