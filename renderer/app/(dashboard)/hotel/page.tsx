...
import { Plus, BedDouble, Users, ClipboardList, Calendar, LogOut, LogIn, Share2, Copy, Check, ExternalLink } from 'lucide-react';
          ...
          <div className="bg-surface-card border border-surface-border rounded-2xl shadow-2xl w-full max-w-md overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between px-5 py-4 border-b border-surface-border">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-content-primary">Partager les réservations en ligne</h3>
              </div>
            ...
            <div className="p-5 space-y-4">
              ...
              <a
                href={`https://wa.me/?text=${encodeURIComponent(`Réservez votre chambre en ligne directement ici :\n${hotelUrl}`)}`}
                target="_blank"
              ...
              <p className="text-xs text-content-muted text-center">
                Les clients choisissent leurs dates, voient les chambres disponibles en temps réel, et réservent en quelques secondes.
              </p>
            </div>
          </div>
        </div>
