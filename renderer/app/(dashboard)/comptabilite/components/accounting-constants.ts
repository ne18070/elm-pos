...
export const SOURCE_LABELS: Record<string, { label: string; color: string }> = {
  ...
  stock:         { label: 'Achat',       color: 'text-blue-900 bg-badge-info border-blue-800'                  },
  ...
  voiture:       { label: 'Véhicule',    color: 'text-yellow-900 bg-yellow-900/20 border-yellow-700'           },
  honoraires:    { label: 'Honoraires',  color: 'text-violet-900 bg-violet-900/20 border-violet-700'           },
  service_order: { label: 'Prestation',  color: 'text-emerald-900 bg-emerald-900/20 border-emerald-700'       },
  rental:        { label: 'Location',    color: 'text-rose-900 bg-rose-900/20 border-rose-700'                 },
};
...
export const OP_TEMPLATES: OpTemplate[] = [
  ...
  { id: 'impots',       label: 'Impôts / Taxes',            desc: "Paiement d'impôts ou taxes (patente, TS…)", icon: TrendingDown, category: 'charges', defaultDesc: 'Impôts et taxes',            hasPay: true,  debit: { code: '647', name: 'Impôts et taxes' },                      credit: { code: '571', name: 'Caisse' } },
