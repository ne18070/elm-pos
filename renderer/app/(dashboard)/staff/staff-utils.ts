...
export const ATTENDANCE_CFG: Record<AttendanceStatus, { label: string; short: string; color: string; bg: string }> = {
  ...
  retard:   { label: 'Retard',        short: 'R',  color: 'text-status-orange',   bg: 'bg-badge-orange border-status-orange'    },
...
export const CYCLE: (AttendanceStatus | null)[] = ['present', 'retard', 'absent', 'half_day', 'leave', 'holiday', null];
