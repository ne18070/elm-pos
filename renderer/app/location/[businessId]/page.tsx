    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex flex-wrap gap-2 text-xs">
          {vehicle.color && (
            <span className="flex items-center gap-1 bg-slate-50 border border-slate-100 px-2 py-0.5 rounded-full text-slate-500">
              <span className="w-2 h-2 rounded-full bg-slate-400 inline-block" />
              {vehicle.color}
            </span>
          )}
          {vehicle.license_plate && (
            <span className="bg-slate-50 border border-slate-100 px-2 py-0.5 rounded-full text-slate-500 font-mono">
              {vehicle.license_plate}
            </span>
          )}
        </div>
        ...
        {vehicle.description && (
          <p className="text-xs text-slate-500 line-clamp-2">{vehicle.description}</p>
        )}
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="bg-slate-50 rounded-xl p-3 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500">{formatCurrency(selected.price_per_day, currency)}/jour</p>
                </div>
              ...
              <div className="space-y-3">
                <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Vos informations</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="text-xs text-slate-500 block mb-1">N° pièce d'identité</label>
                    <input
                      type="text"
                ...
                <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide pt-1">Lieux</p>

                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs text-slate-500 block mb-1">Lieu de départ</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-xs text-slate-500 block mb-1">Lieu de retour</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="text-xs text-slate-500 block mb-1">Notes / demandes spéciales</label>
                  <textarea
                    rows={2}
                    value={form.notes}
