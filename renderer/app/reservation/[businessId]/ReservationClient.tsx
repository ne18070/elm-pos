      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          <button
            ...
            className="ml-auto flex items-center gap-1.5 bg-brand-600 hover:bg-brand-700 text-content-primary text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors"
          >
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-5">
        ...
        <div className="bg-surface-card rounded-2xl shadow-sm border border-surface-border p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div>
              <label className="block text-xs font-semibold text-content-muted mb-1.5">Départ</label>
              <input
                type="date"
                value={checkOut}
                min={checkIn}
          ...
          <button
            ...
            className="w-full bg-brand-600 hover:bg-brand-700 disabled:opacity-60 text-content-primary font-bold py-3.5 rounded-xl transition-colors flex items-center justify-center gap-2"
          >
            {loading ? (
          ...
          >
            ...
            <form onSubmit={handleReserve} className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              <section className="space-y-3">
                ...
                <div>
                  <label className="block text-xs font-medium text-content-muted mb-1.5">Email (optionnel)</label>
                  <input
                    type="email"
                    value={guestEmail}
                ...
                <div>
                  <label className="block text-xs font-medium text-content-muted mb-1.5">Demandes spéciales (optionnel)</label>
                  <textarea
                    rows={2}
                    value={notes}
